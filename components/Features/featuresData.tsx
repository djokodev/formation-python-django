...
const featuresData: Feature[] = [
  {
    ...
    title: "Livres PDF ? 😐",
    paragraph:
      "De ma modeste expérience, j'ai remarqué que lire des livres m'aide vraiment à approfondir mes connaissances, bien plus que de suivre des tutoriels vidéo. Quand je regarde un tuto, je sais que ce qui est présenté est valide, mais cela reste teinté de la perspective personnelle de l'auteur. En revanche, lorsque je lis un livre, j'ai l'impression d'acquérir une base solide qui me permet de mieux manier mes outils par la suite. Ce n'est que mon avis, et cela peut varier d'une personne à l'autre, mais je partage simplement ce qui fonctionne pour moi 😉",
  },
  {
    id: 1,
    icon: (
    ...
    title: "La Roadmap",
    paragraph:
      "Si vous avez déjà développé une application web de A à Z et l’avez mise en production avec Python et Django, ce programme n’est pas pour vous ! Mais si vous débutez en programmation ou ignorez encore ce qu’est un éditeur de code, alors bienvenue, vous êtes au bon endroit. Ce programme a été conçu pour vous guider pas à pas, avec un parcours structuré qui vous mènera jusqu’au niveau de développeur junior confirmé. Avec plus de 15 livres soigneusement sélectionnés, vous progresserez à chaque étape.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Mentorat 🏳️",
    paragraph:
      "Vous n’êtes pas seul dans cette aventure ! Tout au long de votre parcours, je serai là pour vous guider, répondre à vos questions, et vous aider à surmonter chaque défi. Pensez à moi comme à votre mentor dédié, toujours prêt à vous fournir des conseils et des astuces pour progresser efficacement. Mon objectif est que vous atteigniez vos objectifs avec confiance et compétence, et que vous sortiez de ce programme en ayant construit des bases solides et des compétences concrètes.",
  },
  {
    id: 1,
    icon: (
...
,
  },
  {
    ...
    title: "📢Les projets en question ? 😶",
    paragraph:
      "Dans cette formation, nous développerons trois projets pratiques : 🎥 1. Plateforme de Partage de Vidéos avec Récompenses automatique lier aux actions des utilisateurs. 🔗 2. API REST pour la Collaboration de Projet. 🛒 3. Site de E-commerce.", 
  },
